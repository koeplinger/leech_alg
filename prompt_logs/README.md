...
| [058_add_petersson_citation_in_kirmse_remark.txt](058_add_petersson_citation_in_kirmse_remark.txt) | Petersson [17] added as "see also … for a modern account" in the Kirmse-convention remark |
| [059_early_circulation_feedback_round1.txt](059_early_circulation_feedback_round1.txt) | Early-circulation feedback round 1: Lemma 4.5 merged into Remark 4.6 ("four lemmas"); Prop 4.10 merged into prose; Wilson 2009 description corrected (no 3×3 matrices); Dixon 2010 XY-product proper formula; abstract expanded with Kirmse→Coxeter→σ chain |
| [060_baez_egan_rewrite.txt](060_baez_egan_rewrite.txt) | Baez/Egan paragraph rewritten with verified details (parts 9–10, Egan's 17,280 Leech embeddings, Baez's open question and negative conjecture); Baez2014 bibitem updated |
| [061_dixon_1995_reference.txt](061_dixon_1995_reference.txt) | Dixon 1995 (hep-th/9506080) added as bibitem; short footnote on §7 Dixon paragraph noting the 1995 precursor and Wilson's short correction as structurally analogous to Kirmse–Coxeter |
| [062_housekeeping_after_feedback_round1.txt](062_housekeeping_after_feedback_round1.txt) | Housekeeping after feedback round 1: README, CURRENT_STATE, python READMEs, key-claims index, research_result.md, symbolic_proof_checks docstring updated ("four lemmas"); forward correction appended to prior_art_orders_on_leech.txt |
| [063_merge_forward_corrections_into_prior_art.txt](063_merge_forward_corrections_into_prior_art.txt) | Forward corrections (prompt 062 appendix) merged into main body of prior_art_orders_on_leech.txt; appendix removed; timestamp refreshed to 2026-04-14 |
| [064_additional_prior_art_leech_constructions.txt](064_additional_prior_art_leech_constructions.txt) | Added three earlier-precursor references (Conway–Sloane 1982, Lepowsky–Meurman 1982, Elkies–Gross 1996) to prior-art registry and paper §7; Frenkel authorship corrected to Lepowsky–Meurman alone |
| [065_companion_paper_kirmse_analogy.txt](065_companion_paper_kirmse_analogy.txt) | Companion paper (paper/companion.tex) written as a gentle Kirmse→Coxeter→σ exposition with paired abstract/concrete witnesses at E₈ and Leech levels; does not answer the circulated feedback |
| [066_main_paper_two_framings_remark.txt](066_main_paper_two_framings_remark.txt) | Remark rem:two-framings added to main.tex: Λ⋆Λ⊆Λ ⟺ Σ(Λ)⋆₀Σ(Λ)⊆Σ(Λ) via Σ=σ⊕σ⊕σ; neither says Λ⋆₀Λ⊆Λ (which fails) — distinctness from σ(Ls)≠Ls |
| [067_two_framings_remark_repositioned.txt](067_two_framings_remark_repositioned.txt) | Remark rem:two-framings moved from §1 to §4.2 (after rem:Ls-not-closed) so all cross-references point backwards; Theorem 1.1 cited as "the central theorem" |
| [068_companion_paper_example_numbering_and_kirmse_question.txt](068_companion_paper_example_numbering_and_kirmse_question.txt) | Companion paper: example numbering fixed (\newtheorem starred → unstarred); new §10 "Could the σ-twist undo Coxeter's fix?" — answers no, on structural grounds (different levels; σ(L)=L) |
| [069_companion_paper_authorship_and_abstract.txt](069_companion_paper_authorship_and_abstract.txt) | Companion paper: author changed from Köplinger to Claude Opus 4.6 (max thinking), Anthropic; abstract reframed as AI-authored training material from the repo corpus; static date 14 April 2026; repo link added |
