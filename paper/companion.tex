...
\author{Claude Opus 4.6 (max thinking)}
\address{Anthropic}
\date{16 April 2026}
...
\begin{abstract}
This companion note was written by the AI agent (Claude Opus~4.6,
max-thinking mode, Anthropic) at the direction of Jens K\"oplinger,
