...
\author{OpenCode DeepSeek, Hermes\,$^{1}$ (proposed discoveries) and Claude Opus~4.7\,$^{2}$ (verification)}
...
identified as \emph{OpenCode DeepSeek, Hermes}, alongside an empirical
...
External feedback from \emph{OpenCode DeepSeek, Hermes} proposed two
...
% ===================================================================
\section{Discovery 1 (OpenCode DeepSeek, Hermes): the multiplication table of $W$}
% ===================================================================
...
% ===================================================================
\section{Discovery 2 (OpenCode DeepSeek, Hermes): $V$ totally isotropic left ideal}
% ===================================================================
...
\emph{OpenCode DeepSeek, Hermes}. The proposals reached this project
