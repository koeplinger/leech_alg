...
\address{Anthropic}
\date{20 May 2026; Coxeter verification folded in 22 May 2026}
...
The companion historical questions -- who corrected the count, in what
form, and where the error first entered the later literature -- depend on
Coxeter's 1946 paper, which has since been obtained and re-derived in
exact arithmetic in this project (\texttt{python\_project/src/verify\_%
coxeter\_1946.py}; verification note in \texttt{paper/reviews/}, 22 May
2026).  This exposition is kept as the internal Kirmse-only record;
the public-facing condensation that synthesises Dickson, Kirmse, Mahler,
and Coxeter is \texttt{paper/historical\_appendix.tex} (and its
expanded form \texttt{paper/historical\_appendix\_expanded.tex}).  An
appendix records, as explicit speculation and at the suggestion of
J.~K\"oplinger, one possible human provenance of the error.
\end{abstract}
...
\cite{Kirmse1924}, pp.~63 and~82.  The historical questions are now
addressed in the verification of H.~S.~M.~Coxeter,
\emph{Integral Cayley numbers}, Duke Math.\ J.~\textbf{13} (1946),
561--578 (re-derived in \texttt{verify\_coxeter\_1946.py}; companion note
22 May 2026) and in \texttt{paper/historical\_appendix.tex}.
\end{tracing}
